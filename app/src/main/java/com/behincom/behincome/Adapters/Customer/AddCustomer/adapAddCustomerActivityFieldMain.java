...
public class adapAddCustomerActivityFieldMain extends RecyclerView.Adapter<adapAddCustomerActivityFieldMain.AdapterMember> {
    ...
    public void onBindViewHolder(final AdapterMember holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (fragActivityField.position == position) {
    ...
    private void Click(int position) {
        fragActivityField.refreshActivityFields(lList.get(position).ActivityFieldGroupID);
        fragActivityField.position = position;
        fragActivityField.MainIDSelected = lList.get(position).ActivityFieldGroupID;
