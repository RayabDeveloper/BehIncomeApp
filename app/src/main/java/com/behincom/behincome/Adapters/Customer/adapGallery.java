...
public class adapGallery extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<CustomerImages> lList = new ArrayList<>();

    public adapGallery(Context mCOntext, List<CustomerImages> mList) {
