...
public class adapAddPrefix extends RecyclerView.Adapter<adapAddPrefix.AdapterMember> {

    private Context context;
    RSQLGeter geter = new RSQLGeter();

    private List<Basic_NamePrefixes> lList = new ArrayList<>();
    private List<Basic_NamePrefixes> lListCustomer = new ArrayList<>();

    public adapAddPrefix(List<Basic_NamePrefixes> lList, List<Basic_NamePrefixes> lCustomer, Context mContext) {
        this.lList = lList;
        this.lListCustomer = lCustomer;
        this.context = mContext;
    }

    public List<Basic_NamePrefixes> getList() {
        return lList;
    }
    ...
    public void onBindViewHolder(final AdapterMember holder, final int position) {
        ...
        lblSubTitle.setText(lList.get(position).NamePrefixTitle);
