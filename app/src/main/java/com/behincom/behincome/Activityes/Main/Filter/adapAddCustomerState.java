...
public class adapAddCustomerState extends RecyclerView.Adapter<adapAddCustomerState.AdapterMember> {

    private Context context;
    RSQLGeter geter = new RSQLGeter();

    private List<Basic_CustomerStates> lList = new ArrayList<>();
    private List<Basic_CustomerStates> lListCustomer = new ArrayList<>();

    public adapAddCustomerState(List<Basic_CustomerStates> lList, List<Basic_CustomerStates> lCustomer, Context mContext) {
        this.lList = lList;
        this.lListCustomer = lCustomer;
        this.context = mContext;
    }

    public List<Basic_CustomerStates> getList() {
        return lList;
    }
    ...
    public void onBindViewHolder(final AdapterMember holder, final int position) {
        ...
        lblSubTitle.setText(lList.get(position).CustomerStateTitle);
