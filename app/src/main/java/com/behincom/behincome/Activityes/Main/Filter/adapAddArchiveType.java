...
public class adapAddArchiveType extends RecyclerView.Adapter<adapAddArchiveType.AdapterMember> {

    private Context context;
    RSQLGeter geter = new RSQLGeter();

    private List<Basic_ArchiveTypes> lList = new ArrayList<>();
    private List<Basic_ArchiveTypes> lListCustomer = new ArrayList<>();

    public adapAddArchiveType(List<Basic_ArchiveTypes> lList, List<Basic_ArchiveTypes> lCustomer, Context mContext) {
        this.lList = lList;
        this.lListCustomer = lCustomer;
        this.context = mContext;
    }

    public List<Basic_ArchiveTypes> getList() {
        return lList;
    }
    ...
    public void onBindViewHolder(final AdapterMember holder, final int position) {
        ...
        lblSubTitle.setText(lList.get(position).ArchiveTypeTitle);
