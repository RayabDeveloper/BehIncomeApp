...
public class adapAddTagSub extends RecyclerView.Adapter<adapAddTagSub.AdapterMember> {
    ...
    public adapAddTagSub(List<Basic_Tags> lList, List<Basic_Tags> lCustomer, Context mContext) {
        this.lList = lList;
